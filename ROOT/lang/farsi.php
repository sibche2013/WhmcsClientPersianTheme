...
$_LANG['cartdomainsconfigdesc'] = "در زیر شما میتوانید نام های دامنه را در سبد خرید خود قرار دهید،اطلاعات لازم و نام های سرور را برای آن مشخص کنید";
...
$_LANG['cartproductdomainuseincart'] = "از دامنه که هم اکنون در سبد خرید است استفاده شود";
...
$_LANG['clientareanavchangecc'] = "تغییر مشخصات سبد خرید اعتباری ";
...
$_LANG['creditcard'] = "پرداخت با سبد خرید اعتباری";
$_LANG['creditcard3dsecure'] = "هم اکنون برای جلوگیری از کلاه برداری سوالاتی در زمنیه سرویس های سبد خرید اعتباری تایید شده شما نمایان می شود";
$_LANG['creditcardcardexpires'] = "تاریخ انقضا";
$_LANG['creditcardcardissuenum'] = "شماره مورد";
$_LANG['creditcardcardnumber'] = "شماره سبد خرید";
$_LANG['creditcardcardstart'] = "تاریخ شروع";
$_LANG['creditcardcardtype'] = "نوع سبد خرید";
$_LANG['creditcardccvinvalid'] = "کد سبد خرید ورودی شما غیر مجاز است";
$_LANG['creditcardconfirmation'] = " متشکریم! مشخصات جدید سبد خرید شما پذیرفته شد و اولین پرداخت از حساب شما برداشته شد.شما ایمیل تاییدیه در این باره دریافت خواهید کرد.";
$_LANG['creditcardcvvnumber'] = "CVV/CVC2 شماره";
$_LANG['creditcardcvvwhere'] = "کجا میتوانم آن را بیابم ؟";
$_LANG['creditcarddeclined'] = "مشخصات سبد خریدی که شما وارد کردید پذیرفته نشد . لطفا سبد خرید دیگری را امتحان کنید یا با پشتیبانی تماس بگیرید.";
$_LANG['creditcarddetails'] = "مشخصات سبد خرید اعتباری";
$_LANG['creditcardenterexpirydate'] = "تاریخ انقضای سبد خرید را وارد نکردید";
$_LANG['creditcardenternewcard'] = "وارد کردن اطلاعات سبد خرید جدید در زیر ";
$_LANG['creditcardenternumber'] = "شماره سبد خرید خود را وارد نکرده اید.";
$_LANG['creditcardinvalid'] = "مشخصات سبد خرید شما غیر مجاز است.لطفا سبد خرید دیگری را امتحان کنید یا با پشتیبانی تماس بگیرید.";
$_LANG['creditcardnumberinvalid'] = "شماره سبد خرید اعتباری وارد شده اشتباه است.";
$_LANG['creditcardsecuritynotice'] = "هر تاریخی که شما وارد کنید محرمانه باقی میماند و برای کاهش ریسک تقلب مخفی میباشد ";
$_LANG['creditcarduseexisting'] = "استفاده از سبد خرید موجود";
...
$_LANG['invoicenumber'] = "شماره فاکتور : ";
$_LANG['invoiceofflinepaid'] = "پروسه پرداخت آفلاین با سبد خرید اعتباری بصورت دستی انجام میشود.هنگامی که پروسه پرداخت تکمیل شود شما ایمیل تاییدیه دریافت خواهید کرد .";
...
$_LANG['invoicestransactions'] = "پرداخت ها";
...
$_LANG['invoicestransnonefound'] = "پرداخت مربوطی یافت نشد";
...
$_LANG['maxmind_highfraudriskscore'] = "اینجا متوجه ریسک بالای تقلب برای سفارش شما شده است و آن را ممنوع میکند ";
...
$_LANG['no'] = "خیر";
$_LANG['nocarddetails'] = "رکوردی از مشخصات سبد خرید موجود نمیباشد";
$_LANG['none'] = "هیچکدام";
...
$_LANG['orderpromovalidatebutton'] = "افزودن کد تخفیف >>";
...
$_LANG['creditcardnostore'] = "اگر شما نمی خواهید اطلاعات سبد خرید شما برای پرداخت های بعدی به صورت خودکار نزد ما بماند، این قسمت را تیک بزنید.";
$_LANG['creditcarddelete'] = "حذف اطلاعات سبد خرید های ذخیره شده";
$_LANG['creditcarddeleteconfirmation'] = "اطلاعات ذخیره شده سبد خرید های شما اکنون حذف گردیدند.";
$_LANG['creditcardupdatenotpossible'] = "اطلاعات سبد خرید هم اکنون قابل به روز رسانی نیست. لطفا بعدا تلاش فرمایید.";
...
$_LANG['ordersummarybegin'] = "سبد خرید خالی است.لطفا محصولی را برای شروع انتخاب کنید...";
...
$_LANG['quoterecipient'] = "مشخصات سفارش دهنده :";
...
$_LANG['step'] = "مرحله %s";
$_LANG['cartdomainexists'] = "این دامنه در اینجا وجود دارد بنابراین مجددا قابل سفارش نیست";
...
$_LANG['cartreviewcheckout'] = "مرور و پرداخت سفارش";
...
$_LANG['cartaddandcheckout'] = "افزودن به سبد خرید و پرداخت سفارش";
...
$_LANG['ajaxcartcheckout'] = "رفتن مستقیما به پرداخت سفارش »";
$_LANG['ordersummarybegin'] = "سبد خرید خالی است.لطفا محصولی را برای شروع انتخاب کنید...";
$_LANG['ajaxcartconfigreqnotice'] = "شما در حال ثبت نام هستید ، ولی قبل از آن باید دامنه را انتخاب کنید تا بتوانید محصول انتخابی را به سبد خرید خود اضافه کنید...";
...
$_LANG['invoicepdfgenerated'] = "تاریخ پرینت برگه : ";
...
$_LANG['navmanagecc'] = "مدیریت کردیت سبد خرید";
...
$_LANG['clientareanavccdetails'] = "مشخصات سبد خرید اعتباری";
...
$_LANG['ccexpiringsoon'] = "سبد خرید اعتباری به زودی باطل خواهد شد";
$_LANG['ccexpiringsoondesc'] = "سبد خرید اعتباری شما به زودی منقضی میشود بنابراین هر زمان توانستید، %sاطلاعات جدید را در سایت بروز رسانی%s کنید";
...
$_LANG['twofabackupcodeexpl'] = "این کد را در جایی امن نگهداری کنید.این کد در مواقعی که دستگاه تایید هویت دو مرحله ای را همراه نداشته باشید یا آن را گم کرده باشید به سبد خریدان خواهد آمد.";
...
$_LANG['masspayintro'] = "پرداخت کل صورت حساب ها با یک کلیک.";
$_LANG['masspaymentselectgateway'] = "انتخاب درگاه جهت پرداخت انبوه";
...
$_LANG['exampledomain'] = "مانند : example.com";
...
$_LANG['outOfStockProductRemoved'] = "محصولی که موجود نیست به صورت خودکار از سبد خرید شما حذف شد";
...
$_LANG['clientHomePanels']['affiliateSummaryWithdrawalReady'] = "میزان کمیسیون فعلی شما :commissionBalance می باشد.شما می توانید هم اکنون تسویه حساب نمایید .";
...
$_LANG['domainchecker']['alreadyincarttitle'] = "در سبد خرید موجود است";
$_LANG['domainchecker']['alreadyincartmsg'] = "این دامنه در سبد خرید شما موجود است. جهت تکمیل خرید لطفا هزینه را پردات کنید";
...
$_LANG['unableToLoadShoppingCart'] = "دسترسی به سبد خرید امکان پذیر نیست. لطفا با بخش پشتیبانی در ارتباط باشید.";
...
$_LANG['orderForm']['transferExistingDomain'] = "دامنه ی فعلی خود را به اینجا منتقل کنید";
$_LANG['orderForm']['www'] = "www.";
$_LANG['orderForm']['check'] = "بررسی";
$_LANG['orderForm']['returnToClientArea'] = "بازگشت به محیط کاربری";
$_LANG['orderForm']['checkout'] = "پرداخت سفارش";
...
$_LANG['orderForm']['cardNumber'] = "شماره سبد خرید";
...
$_LANG['orderForm']['addToCart'] = "افزودن به سبد خرید";
$_LANG['orderForm']['addedToCartRemove'] = "اضافه به سبد خرید (حذف)";
$_LANG['orderForm']['configureDesiredOptions'] = "تنظیمات مورد نظر خود را جهت ثبت سفارش انتخاب نمایید.";
...
$_LANG['orderForm']['domainAddedToCart'] = "این دامنه به سبد خرید شما اضافه شد";
...
$_LANG['orderForm']['updateTotals'] = "بروز رسانی مجموع";
$_LANG['orderForm']['continueShopping'] = "افزودن سفارش دیگر";
...
$_LANG['oauth']['copyrightFooter'] = "تمامی حقوق برای :companyName محفوظ می باشد . &copy; :dateYear";
...
$_LANG['downloadLoginRequiredTagline'] = "لطفا وارد پنل کاربریتان شوید تا بتوانید به فایل مورد نظر دسترسی پیدا کنید.";
...
$_LANG['orderForm']['domainIsUnavailable'] = "<strong>:domain</strong> موجود نیست";
...
$_LANG['orderForm']['transferToUs'] = "دامنه خود را به اینجا انتقال دهید";
...
$_LANG['orderForm']['extendExclusions'] = "به جز دامنه های خاص";
...
$_LANG['orderForm']['authCodePlaceholder'] = "Epp Code کد انتقال دامنه";
$_LANG['orderForm']['authCodeTooltip'] = "جهت انتقال دامنه خود می بایست کد انتقال دامنه را از ثبت کننده فعلی دامنه ی خود دریافت کنید و در کادر مقابل وارد نمایید . کد انتقال همان کد EPP  می باشد.";
...
$_LANG['orderForm']['transferAlternativelyRegister'] = "همچنین شما می توانید این دامنه را هم اکنون ثبت نمایید.";
...
$_LANG['orderForm']['domainPriceTransferLabel'] = "انتقال به اینجا و تمدید دامنه به مدت یکسال دیگر";
...
$_LANG['filemanagement']['checkPermissions'] = "لطفا سطح دسترسی را بررسی نمایید.";
$_LANG['filemanagement']['checkAvailableDiskSpace'] = "لطفا فضای دیسک را بررسی نمایید.";
$_LANG['filemanagement']['fileAlreadyExists'] = "فایل در حال حاضر وجود دارد.";
...
$_LANG['clientHomePanels']['showingRecent100'] = "نمایش 100 نتیجه آخر";
$_LANG['orderForm']['domainLetterOrNumber'] = "دامنه باید با یک حرف یا عدد شروع شود";
...
$_LANG['domainCheckerSalesGroup']['sale'] = "حراج";
