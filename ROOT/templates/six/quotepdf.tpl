...
$brTag="<br><br><br><br><br>";
$pdf->writeHTML($brTag, true, false, false, false, '');
...
<table width=\"100%\" bgcolor=\"#ccc\" cellspacing=\"1\" cellpadding=\"2\" border=\"0\">
    ...
    <tr bgcolor=\"#fff\">
        ...
        <td align=\"center\">{$datecreated}<br>(".jdate("Y/m/d", strtotime($datecreated)).")</td>
        <td align=\"center\">{$validuntil}<br>(".jdate("Y/m/d", strtotime($validuntil)).")</td>
    </tr>
</table>";
